  ...
  >
    ...
    <div class="d-flex align-center justify-space-between px-2 py-2">
      <div class="d-flex align-center">
        ...
        <img src="/images/header/logo.png" alt="ZTECH Logo" class="ztech-logo ml-1" loading="lazy" />
      </div>
  ...
  <div class="feature-nav">
    <v-container class="feature-container">
      ...
      >
        ...
        <span class="feature-title inter-14-regular-uppercase">{{ feature.title }}</span>
      </nuxt-link>
    </v-container>
  </div>
</template>
